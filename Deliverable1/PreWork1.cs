...
namespace Deliverable1
{
    ...
    {   /*I create a constant to determine the size of
        *the array's that I will create later*/
        ...
        {
            /*Here is where I first create a public array of integers that I can populate with user inputs
             ...
             * which uses the pointer object to determine where to place the data
             * I also use the "this" modifer/extension to assign the start location of my array*/
             ...
             * to continue with the loop. Then in the third clause I tell the loop to
             * incrementally add 1 to the variable i with the logical operator ++
             * I use the console write command to ask the user for input
             * which then use the PushTo extension, and ConvertToInt32 method to add the user input to my array.
